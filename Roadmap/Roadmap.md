...
- **Implemented Architecture**:
  ...
  - Retain, archive, reactivate, and confirmed permanent-delete policies provide an auditable lifecycle backed by the current schema 9 persistence and atomic restore validation.
