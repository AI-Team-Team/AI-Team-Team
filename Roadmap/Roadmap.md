...
- **Implemented Architecture**:
  ...
  - Retain, archive, reactivate, and confirmed permanent-delete policies provide an auditable lifecycle backed by the current schema 8 persistence and atomic restore validation.
