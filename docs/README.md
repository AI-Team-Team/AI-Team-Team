...
4. **[State Persistence & Multi-Turn Memory](State_Persistence.md)**: Explains the SQLite-backed state snapshotting structure, ER diagrams, recovery lifecycles, and Multi-Turn agent memory switches.
