...
Schema 8 retains the communication request, ordered approval, ballot, Agreement, peer-delivery, and correlated AgentTeam inbox records introduced with the autonomous communication model.
