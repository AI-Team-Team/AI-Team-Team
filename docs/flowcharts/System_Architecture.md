...
flowchart TB
    ...
    subgraph Knowledge["Team Knowledge and Private Agent Workspaces"]
        ...
        GatedReader["Token-Bounded Model Reader<br/>effective-model counting and exact continuation"]
        WorkspaceReader["Trusted Host Range Reader<br/>secure raw reads without model budgets"]
